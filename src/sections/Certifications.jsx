  ...
  return (
    <section id="certifications" className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
      <SectionHeader
        ...
        description="Portfolio evidence and learning milestones aligned to Mary Abenawa Techiesiwa Amoah’s SOC operations, automation, threat intelligence, and cybersecurity education focus."
      />
